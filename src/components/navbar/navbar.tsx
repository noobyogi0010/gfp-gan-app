...
export default function Navbar() {
    return (
        <div className="flex flex-col flex-1 bg-zinc-100 p-4 border-b-2 border-zinc-300 justify-center items-center">
            ...
            <a href="" className="flex items-center text-xs text-zinc-500 hover:underline mt-1">
                Visit the Github Repo 
                {/* <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" className="ml-2">
